...
ThemeData doReflect() {
  ThemeData instanceThemeData = new ThemeData();
  InstanceMirror instanceMirrorThemeData =
      myReflectableNew.reflect(instanceThemeData);
  ClassMirror classMirrorThemeData = myReflectableNew.reflectType(ThemeData);
  return instanceThemeData;
}
